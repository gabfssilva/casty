...
(`src/casty/__init__.pyi`) and of the Python modules. The guide and the guarantees are in the
...
| [`casty.stores`](stores.md) | The stores casty carries: `SQL`, a `Store` over a SQL database |
