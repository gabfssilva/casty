...
Requer `uv`, Python 3.13 ou superior, uma toolchain Rust e as portas TCP locais `7421` e `7422` livres. Execute cada bloco em um terminal separado, partindo da raiz do repositório; o `uv` compila e instala a versão local do casty.
